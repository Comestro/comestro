        ...
        <div class="flex flex-col lg:flex-row gap-8">
          ...
          <div class="lg:w-2/3 w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
              <div class="bg-white overflow-hidden">
                ...
                <div class="p-6">
                  <h3 class="text-lg font-semibold">Even the all-powerful Pointing</h3>
                  <p class="text-sm text-gray-500 mt-2">July 12, 2018 - Admin • 3</p>
                  <p class="text-gray-600 mt-4 text-sm">
                    Far far away, behind the word mountains, far from the countries Vokalia and Consonantia...
                  </p>
                  <a href="{{route('read-more')}}" class="mt-4 text-pink-500 hover:underline">Read More &rarr;</a>

                </div>
              </div>
      
              <div class="bg-white overflow-hidden">
                <img src="https://th.bing.com/th/id/OIP.N4W-pN3fBtrtT2OXwntVDgHaFj?w=261&h=196&c=7&r=0&o=5&pid=1.7" alt="Blog Post 2" class="w-full h-64 object-cover">
                <div class="p-6">
                  <h3 class="text-lg font-semibold">Even the all-powerful Pointing</h3>
                  <p class="text-sm text-gray-500 mt-2">July 12, 2018 - Admin • 3</p>
                  <p class="text-gray-600 mt-4 text-sm">
              ...
              <div class="bg-white  overflow-hidden">
                  ...
                  <div class="p-6">
                    ...
                    <button class="mt-4 text-pink-500 hover:underline">Read More &rarr;</button>
                  </div>
                </div>
                <div class="bg-white overflow-hidden">
                  <img src="https://th.bing.com/th/id/OIP.N4W-pN3fBtrtT2OXwntVDgHaFj?w=261&h=196&c=7&r=0&o=5&pid=1.7" alt="Blog Post 2" class="w-full h-48 object-cover">
                  <div class="p-6">
                    <h3 class="text-lg font-semibold">Even the all-powerful Pointing</h3>
                    <p class="text-sm text-gray-500 mt-2">July 12, 2018 - Admin • 3</p>
                    <p class="text-gray-600 mt-4 text-sm">
          ...
          <aside class="lg:w-1/3 w-full bg-white  p-6">
            ...
            <img src="https://colorlib.com/wp/wp-content/uploads/sites/2/colorlib-custom-web-design.png.avif" alt="Popular Course Image" class="mt-4 w-full rounded-lg shadow-md">
            <input type="text" placeholder="Search" class="w-full border px-3 py-2 rounded-md mt-4">
            <ul class="mt-4 space-y-2">
              <li class="text-blue-500">Mastering React & Tailwind CSS</li>
              <li class="text-blue-500">PHP & Laravel for Web Development</li>
              <li class="text-blue-500">Python for Data Science</li>
            </ul>
            ...
            <div class="flex items-center mt-4 space-x-4">
                <img src="https://colorlib.com/wp/wp-content/uploads/sites/2/how-to-setup-website-130x73.jpg" alt="Info Image" class="w-16 h-16 rounded-lg shadow-md">
                <p class="text-gray-700 text-sm">Stay updated with our latest courses and news!</p>
            </div>
            <hr class="mt-3">
            <div class="flex items-center mt-4 space-x-4">
                <img src="https://colorlib.com/wp/wp-content/uploads/sites/2/html5-parallax-website-templates-130x87.jpg" alt="Info Image" class="w-16 h-16 rounded-lg shadow-md">
                <p class="text-gray-700 text-sm">Stay updated with our latest courses and news!</p>
            </div>
          
            <hr class="mt-3">
            <div class="flex items-center mt-4 space-x-4">
                <img src="https://colorlib.com/wp/wp-content/uploads/sites/2/cleaning-company-websites-130x90.jpg" alt="Info Image" class="w-16 h-16 rounded-lg shadow-md">
                <p class="text-gray-700 text-sm">Stay updated with our latest courses and news!</p>
            </div>
        </div>
    </aside>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
          ...
          <div class="lg:w-2/3 w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
              <div class="bg-white overflow-hidden">
                <img src="https://colorlib.com/wp/wp-content/uploads/sites/2/squarespace-photographer-templates-408x331.png" alt="Blog Post 1" class="w-full h-48 object-cover">
                <div class="p-6">
                  <h3 class="text-lg font-semibold">Even the all-powerful Pointing</h3>
                  <p class="text-sm text-gray-500 mt-2">July 12, 2018 - Admin • 3</p>
                  <p class="text-gray-600 mt-4 text-sm">
              ...
              <div class="bg-white overflow-hidden">
                <img src="https://colorlib.com/wp/wp-content/uploads/sites/2/7_wedding-photography-websites-408x236.jpg.avif" alt="Blog Post 2" class="w-full h-64 object-cover">
                <div class="p-6">
                  <h3 class="text-lg font-semibold">Even the all-powerful Pointing</h3>
                  <p class="text-sm text-gray-500 mt-2">July 12, 2018 - Admin • 3</p>
                  <p class="text-gray-600 mt-4 text-sm">
          ...
          <!-- Sidebar -->
          <aside class="lg:w-1/3 w-full   p-6">
            <h2 class="text-lg font-bold">We Recommend</h2>
            <img src="https://colorlib.com/wp/wp-content/uploads/sites/2/jevelin-2022.png.webp" alt="Popular Course Image" class="mt-4 w-full rounded-lg shadow-md">
            <img src="https://colorlib.com/wp/wp-content/uploads/sites/2/gillion-2022.png.webp" alt="Popular Course Image" class="mt-4 w-full rounded-lg shadow-md">
    </aside>
      </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="mt-6">
                        ...
                        <form>
                            ...
                            <button type="submit" class="mt-4 px-6 py-2 bg-pink-600 text-white rounded-full font-semibold hover:bg-pink-700 transition-colors">Post Comment &rAarr;</button>
                        </form>
                    </div>
