        ...
        <div class="relative z-10 min-h-screen">
            <div class="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-6xl px-4 z-20">
                <div class="bg-[#0D3C4B] p-6 rounded-lg shadow-lg text-center">
                    ...
                    <p class="text-lg text-gray-300 mb-8">Get in touch with us for any inquiries or collaborations.</p>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 ">
                    ...
                    <div class="space-y-8">
                        <div class="bg-[#0D3C4B] p-6 rounded-lg shadow-lg">
                            ...
                            <div class="space-y-4">
                                <p class="flex items-center justify-center md:justify-start"><svg class="w-5 h-5 mr-2 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg> 123 Comestro, Purnea, Bihar</p>
                                ...
                                <p class="flex items-center justify-center md:justify-start"><svg class="w-5 h-5 mr-2 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg> comessto@gmail.com</p>
                            </div>
                        </div>
