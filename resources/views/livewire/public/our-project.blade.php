<div class="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
    ...
    <div class="absolute bottom-0 left-0 w-96 h-96 bg-indigo-500/5 rounded-full translate-y-1/2 -translate-x-1/3"></div>
    
    <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Section header -->
        <div class="max-w-3xl mx-auto text-center mb-20">
            <span class="inline-block py-1 px-3 rounded-full bg-blue-50 text-blue-600 text-sm font-medium tracking-widest mb-5">OUR PORTFOLIO</span>
            <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                Transforming Ideas Into<br><span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Exceptional Projects</span>
            </h2>
                ...
                <div class="group">
                    <div class="flex flex-col {{ $work->image_position ? 'lg:flex-row' : 'lg:flex-row-reverse' }} items-center gap-8 lg:gap-16">
                        ...
                        <div class="relative w-full lg:w-1/2 overflow-hidden rounded-2xl shadow-lg">
                            <div class="absolute inset-0 bg-gradient-to-tr from-blue-600/20 to-indigo-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            <img 
                            ...
                            <div class="absolute top-4 right-4 py-1 px-4 bg-white/90 backdrop-blur-sm rounded-full shadow-md">
                                <span class="text-blue-600 text-sm font-medium">{{ $work->category ?? 'Uncategorized' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="w-full lg:w-1/2 {{ $work->image_position ? 'lg:pl-6' : 'lg:pr-6' }}">
                            <div class="max-w-xl">
                                <h3 class="text-3xl font-bold text-gray-900 mb-4 group-hover:text-blue-600 transition-colors">{{ $work->title }}</h3>
                                ...
                                <a 
                                    href="{{ $work->link }}" 
                                    class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg shadow-md hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
                                >
                                    View Case Study
        ...
        @if(count($works) > 3)
            <div class="text-center mt-20">
                <a href="{{ route('portfolio') }}" class="inline-flex items-center px-8 py-4 border-2 border-blue-600 text-blue-600 font-medium rounded-lg hover:bg-blue-50 transition-colors">
                    View All Projects
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
