                ...
                <div class="card">
                   <div class="card-body">
                      <a href="index.html" class="auth-logo">
                         <img src="assets/images/logo-dark.png" class="img-fluid rounded-normal" alt="logo">
                      </a>
                      ...
                      <div class="mb-5">
                         <p class="line-around text-secondary mb-0"><span class="line-around-1">or login with email</span>
                         </p>
                      </div>
                      <form wire:submit.prevent="login">
                            ...
                            <div class="col-lg-12 mt-2">
                               <div class="form-group">
                                  <div class="d-flex justify-content-between align-items-center">
                                     ...
                                     <label class="form-label"><a href="auth-recover-pwd.html" class="text-primary">Forgot
                                           Password?</a></label>
                                  </div>
                         ...
                         <div class="col-lg-12 mt-3">
                            <p class="mb-0 text-center">Don't have an account? <a href="auth-sign-up.html" class="text-primary">Sign Up</a></p>
                         </div>
                      </form>
                   </div>
                </div>
