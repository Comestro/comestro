                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label custom-control-label" for="dark-mode">
                                            <span class="switch-icon-right">
                                                <svg xmlns="http://www.w3.org/2000/svg" id="h-moon" height="20"
                                                    width="20" class="h-6 w-6" fill="none"
                                            ...
                                            <span class="switch-icon-left">
                                                <svg xmlns="http://www.w3.org/2000/svg" id="h-sun" height="20"
                                                    width="20" class="h-6 w-6" fill="none"
                                                    viewbox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                            ...
                            <ul class="navbar-nav ms-auto navbar-list align-items-center">
                                                                ...
                                                                <p class="m-0 pt-1">
                                                                    <small class="text-secondary d-flex">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            class="text-secondary me-2" width="15"
                                                            ...
                                                            <div class="avatar">
                                                                <div class="avatar-img bg-success avatar-20">
                                                                    <span><img class="avatar is-squared rounded-circle"
                                                                            src="{{ asset('assets/images/user/2.jpg" alt="2.jpg') }}"></span>
                                                                </div>
                                                            </div>
                                                            <div class="list-style-detail ms-2 me-2">
                                                                ...
                                                                <p class="m-0">
                                                                    <small class="text-secondary">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            class="text-secondary me-1" width="15"
                                                                            fill="none" viewbox="0 0 24 24"
                                                                            stroke="currentColor">
                                                                            <path stroke-linecap="round"
                                                                                stroke-linejoin="round" stroke-width="2"
                                ...
                                <li class="nav-item nav-icon dropdown">
                                    <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton2"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img src="{{ asset('assets/images/Flag/flag001.png') }}"
                                        ...
                                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div><svg width="24" height="24" viewbox="0 0 24 24"
                                                        fill="primary" xmlns="http://www.w3.org/2000/svg">
                                                        <rect x="3" y="3" width="18" height="18" rx="2"
                                                            fill="#1f1f7a"></rect>
                                                    </svg>
                                                    <span>Incomes</span>
                                                </div>
                                                <div class="ms-3"><svg width="24" height="24"
                                            ...
                                            <tr class="white-space-no-wrap">
                                                <td>
                                                    <h6 class="mb-0 text-uppercase text-secondary">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="pe-2"
                                                            width="30" fill="none" viewbox="0 0 24 24"
                                                            stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
                                                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z">
