                                    ...
                                    <table class="table data-table mb-0">
                                        <thead class="table-color-heading">
                                            <tr class="text-light">
                                                ...
                                                <th><label class="text-muted m-0">account ID</label></th>
                                                            ...
                                                            <a href="" class="text-info me-3" title="View">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                                    ...
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                                        d="M12 4.5C7 4.5 2.5 9 2.5 12s4.5 7.5 9.5 7.5 9.5-4.5 9.5-7.5-4.5-7.5-9.5-7.5zM12 9a3 3 0 100 6 3 3 0 000-6z">
                                                                    </path>
                                                                </svg>
                                                            </a>
