<div>
    <div class="relative bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 min-h-[85vh] flex items-center overflow-hidden">
        <!-- Particles background -->
        <div id="particles-js" class="absolute inset-0"></div>
        
        <!-- Geometric decorative elements -->
        <div class="absolute right-0 top-0 w-96 h-96 bg-blue-500 opacity-10 rounded-full translate-x-1/2 -translate-y-1/2"></div>
        <div class="absolute left-0 bottom-0 w-64 h-64 bg-indigo-500 opacity-10 rounded-full -translate-x-1/3 translate-y-1/3"></div>
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
                ...
                <div class="lg:w-1/2 text-center lg:text-left">
                    ...
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                        Transforming Ideas Into <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">Powerful Software</span>
                    </h1>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="{{ route('contact') }}" class="px-8 py-4 bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-lg transition duration-300 flex items-center justify-center">
                            <span>Get Started</span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                            </svg>
                        </a>
                        <a href="{{ route('service') }}" class="px-8 py-4 border border-blue-400 text-blue-100 hover:bg-blue-800/30 font-medium rounded-lg transition duration-300 flex items-center justify-center">
                            Explore Solutions
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:w-1/2 flex justify-center">
                    <div class="relative">
                        ...
                        <!-- filepath: c:\Users\Admin\Desktop\comestro\public\home\hero-illustration.svg -->
  ...
  <defs>
    ...
    <linearGradient id="pulse2" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <stop offset="100%" stop-color="#8B5CF6"/>
            ...
            <!-- Trusted by logos -->
            <div class="mt-16 pt-8 border-t border-blue-800/50">
