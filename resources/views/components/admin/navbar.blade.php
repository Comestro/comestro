    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="side-menu">
                ...
                <li class="sidebar-layout">
                    <a href="#app1" class="collapsed svg-icon" data-bs-toggle="collapse"
                        aria-expanded="false">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                viewbox="0 0 24 24" stroke="currentColor">
                ...
                <li class="sidebar-layout">
                    <a href="#app6" class="collapsed svg-icon" data-bs-toggle="collapse"
                        aria-expanded="false">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                viewbox="0 0 24 24" stroke="currentColor">
                ...
                <li class="sidebar-layout">
                    <a href="#app2" class="collapsed svg-icon" data-bs-toggle="collapse"
                        aria-expanded="false">
                        <i>
                            <svg class="svg-icon" id="iq-ui-1" width="18"
                ...
                <li class="sidebar-layout">
                    <a href="#app3" class="collapsed svg-icon" data-bs-toggle="collapse"
                        aria-expanded="false">
                        <i>
                            <svg class="svg-icon" id="iq-form-1" width="18"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"
                ...
                <li class="sidebar-layout">
                    <a href="#form2" class="collapsed svg-icon" data-bs-toggle="collapse"
                        aria-expanded="false">
                        <i class="">
            ...
            <li class=" sidebar-layout">
                <a href="chart-apex.html" class="svg-icon">
                    <i class="">
                        <svg class="svg-icon" id="iq-chart-1" width="18"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
