          ...
          <div class="data-scrollbar" data-scroll="1">
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="side-menu">
                          ...
                          <a href="invoice.html" class="svg-icon">
                              <i class="">
                                  <svg class="icon line" width="18" id="receipt" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" stroke="currentColor">
                                      <path d="M17,16V3L13,5,10,3,7,5,3,3V17.83A3.13,3.13,0,0,0,5.84,21,3,3,0,0,0,9,18V17a1,1,0,0,1,1-1H20a1,1,0,0,1,1,1v1a3,3,0,0,1-3,3H6" style="fill: none; stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;">
                                      </path>
                                      <line x1="8" y1="10" x2="12" y2="10" style="fill: none; stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;">
                                      </line>
                                  </svg>
                              </i>
                      ...
                      <li class=" sidebar-layout">
                          <a href="app/calendar.html" class="svg-icon">
                              <i class="">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                      ...
                      <li class="sidebar-layout">
                          ...
                          <ul id="app2" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                              ...
                              <li class=" sidebar-layout">
                                  <a href="ui-box-shadow.html" class="svg-icon">
                                      <i class="">
                                          <svg class="svg-icon" id="iq-ui-1-5" width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" style="stroke-dasharray: 90, 110; stroke-dashoffset: 0;"></path>
                                          </svg>
                      ...
                      <li class="sidebar-layout">
                          ...
                          <ul id="app3" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="sidebar-layout">
                                  <a href="#form1" class="collapsed svg-icon" data-bs-toggle="collapse" aria-expanded="false">
                                      <i class="">
                                  ...
                                  <ul id="form1" class="submenu collapse" data-parent="#app3">
                                      ...
                                      <li class=" sidebar-layout">
                                          <a href="form-input.html" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                      ...
                                      <li class=" sidebar-layout">
                                          <a href="form-checkbox.html" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                  ...
                  <div class="d-flex align-items-center">
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                          <ul class="navbar-nav ms-auto navbar-list align-items-center">
                                                          ...
                                                          <div class="list-style-detail ms-2 me-2">
                                                              ...
                                                              <p class="m-0 pt-1">
                                                                  <small class="text-secondary d-flex">
                                                                      <svg xmlns="http://www.w3.org/2000/svg" class="text-secondary me-2" width="15" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                                                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                                      </svg>
                                                                      3 hours ago</small>
                                                              </p>
                                                      ...
                                                      <div class="list-item d-flex justify-content-start align-items-start">
                                                          <div class="avatar">
                                                              <div class="avatar-img bg-success avatar-20">
                                                                  <span><img class="avatar is-squared rounded-circle" src="{{ asset('assets/images/user/2.jpg" alt="2.jpg')}}"></span>
                                                              </div>
                                                          </div>
                                                          <div class="list-style-detail ms-2 me-2">
                              ...
                              <li class="nav-item nav-icon dropdown">
                                  <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      ...
                                      <div class="card shadow-none m-0 border-0">
                                          <div class=" p-0 ">
                                              <ul class="dropdown-menu-1 list-group list-group-flush">
                                                  <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{ asset('assets/images/Flag/flag-03.png')}}" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;">Spanish</a>
                                                  </li>
                                                  <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{ asset('assets/images/Flag/flag-04.png')}}" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;">Italian</a>
                                                  </li>
                                                  <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{ asset('assets/images/Flag/flag-02.png')}}" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;">French</a>
                                                  </li>
                                                  <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{ asset('assets/images/Flag/flag-05.png')}}" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;">German</a>
                                                  </li>
                                                  <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0" href="#"><img src="{{ asset('assets/images/Flag/flag-06.png')}}" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;">Japanese</a>
                                                  </li>
                                              </ul>
                                          </div>
                                      </div>
                              ...
                              <li class="nav-item nav-icon search-content">
                                  <a href="#" class="search-toggle rounded" id="dropdownSearch" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              ...
                              <li class="nav-item nav-icon dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                      ...
                                      <li class="dropdown-item d-flex svg-icon">
                                          <svg class="svg-icon me-0 text-secondary" id="h-02-p" width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                          </svg>
                                      ...
                                      <li class="dropdown-item d-flex svg-icon">
                                          <svg class="svg-icon me-0 text-secondary" id="h-04-p" width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                  ...
                  <div class="card-body">
                     <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                           ...
                           <div class="ms-3"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="card-body-list">
               <ul class="list-style-3 mb-0">
                  <li class="card-body list-item d-flex justify-content-start align-items-center border-bottom">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="{{ asset('assets/images/products/1.jpg')}}" alt="1.jpg">
                     </div>
                  ...
                  <li class="card-body list-item d-flex justify-content-start align-items-center border-bottom">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="{{ asset('assets/images/products/2.jpg')}}" alt="2.jpg">
                     </div>
                     <div class="list-style-detail ms-3 me-2">
                  ...
                  <li class="card-body list-item d-flex justify-content-start align-items-center border-bottom">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="{{ asset('assets/images/products/13.jpg')}}" alt="3.jpg">
                     </div>
                     <div class="list-style-detail ms-3 me-2">
                  ...
                  <li class="card-body list-item d-flex justify-content-start align-items-center">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="{{ asset('assets/images/products/4.jpg')}}" alt="4.jpg">
                     </div>
                     <div class="list-style-detail ms-3 me-2">
                     ...
                     <tbody>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 me-2">
                                    <img src="{{ asset('assets/images/user/2.jpg')}}" class="img-fluid rounded-circle" alt="image">
                                 </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 me-2">
                                    <img src="{{ asset('assets/images/user/5.jpg')}}" class="img-fluid rounded-circle" alt="image">
                                 </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 me-2">
                                    <img src="{{ asset('assets/images/user/1.jpg')}}" class="img-fluid rounded-circle" alt="image">
                                 </div>
                                 <div>Max Lynn</div>
                              </div>
                           </td>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 me-2">
                                    <img src="{{ asset('assets/images/user/3.jpg')}}" class="img-fluid rounded-circle" alt="image">
                                 </div>
                                 <div>Danniw Yatt</div>
                              </div>
                           </td>
